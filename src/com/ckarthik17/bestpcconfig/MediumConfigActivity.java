...
public class MediumConfigActivity extends Activity
{
    ...
    protected void onResume() {
        ...
        try {
            ...
            TableLayout uiTableLayout =(TableLayout)findViewById(R.id.mediumConfigTable);
    ...
    private class RetrieveBlogContent extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            ...
            HttpGet httpGet = new HttpGet("https://www.googleapis.com/blogger/v3/blogs/230842735819274721/posts/2196091438738422674?key=" + BLOGGER_API_KEY);
            String text = null;
            try {
